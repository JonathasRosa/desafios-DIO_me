//Desafio - Comparando Contas Bancarias
/*
Desafio
...
// Crie o objeto JSON do Cliente 1 e suas propriedades (nome, conta e saldo):
const cliente1 = { 
    nome: gets(),
    conta: parseInt(gets()),
  ...
  // Crie o objeto JSON do Cliente 2 e suas propriedades (nome, conta e saldo):
  const cliente2 = { 
    nome: gets(),
    conta: parseInt(gets()),
    saldo: parseFloat(gets())
